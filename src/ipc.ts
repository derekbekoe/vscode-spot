...
export async function createServer(ipcHandlePrefix: string,
                                   onRequest: (req: http.ServerRequest,
                                               res: http.ServerResponse) => Promise<void> | void) {
...
export class Server {
    ...
    constructor(public ipcHandlePath: string,
                onRequest: (req: http.ServerRequest, res: http.ServerResponse) => Promise<void> | void) {
